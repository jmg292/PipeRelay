    ...
    def writerentry(self, nph, client, mode):
        ...
        while True:
            ...
            if ret == 0:
                err = ctypes.WinError()
                """
                    Error code 9, Windows Error 6 [Invalid Handle] is raised in certain
                    instances where we don't want to raise an exception or terminate the
                    rest of the application.  Silently return in this case.
                """
                if err.errno == 9:
                    return
                ...
                return
                                                              # Temporary fix until is_strans method can be fixed
